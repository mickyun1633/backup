...
-- SQL Error [14155] [72000]: ORA-14155: missing PARTITION or SUBPARTITION keyword : TO 키워드 빼면 오류
...
-- 3) 컬럼 타입/크기 수정(MODIFY)
ALTER TABLE TBL_MEMBER
MODIFY (NAME VARCHAR2(100)); -- 길이 늘리는 것 가능, 크기를 줄일 때는 데이터가 있으면 에러남
...
VALUES(2, '신짱구', 'gu@test.com', 'M', 'Y', SYSDATE, '010-1234-1234', NULL);
